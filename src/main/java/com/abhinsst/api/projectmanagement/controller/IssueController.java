...
import com.abhinsst.api.projectmanagement.model.IssueDTO;
...
import com.abhinsst.api.projectmanagement.service.IssueService;
...
public class IssueController {
  ...
  public ResponseEntity<IssueDTO> createIssue(@RequestBody IssueRequest issue,
    ...
    System.out.println("Issue arrive:--- " + issue);
  ...
  public ResponseEntity<Issue> addUserToIssue(@PathVariable Long issueId, @PathVariable Long userId) throws Exception {
    ...
    Issue issue = issueService.addUserToIssue(issueId, issueId);
